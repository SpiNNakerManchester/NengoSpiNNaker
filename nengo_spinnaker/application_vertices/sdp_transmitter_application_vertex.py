...
from nengo_spinnaker.machine_vertices. \
    sdp_transmitter_machine_vertex import \
    SDPTransmitterMachineVertex

from nengo_spinnaker.nengo_implicit_interfaces.nengo_live_input_interface\
...
class SDPTransmitterApplicationVertex(
    ...
    def output(self, t):
        """This is a interface used by the nengo_spinnaker
        """
        with self._lock:
            return self._output
