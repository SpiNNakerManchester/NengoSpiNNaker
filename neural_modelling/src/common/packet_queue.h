...
static inline bool packet_queue_push(
      packet_queue_t *queue, uint32_t key, uint32_t payload)
{
...
// this succeeded.
static inline bool packet_queue_pop(
      packet_queue_t *queue, packet_t *dest)
{
  if (queue->current > 0)
  {
