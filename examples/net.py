...
def create_model():
    ...
    with model:
        ...
        stimulus_B = nengo.Node(lambda t: np.sin(2 * np.pi * t), label="stim B")
        ens = nengo.Ensemble(n_neurons=1000, dimensions=2, label="ensemble ens")
        ...
        with nengo.Network(label='subnet') as subnet:
            ...
            with nengo.Network() as subsubnet:
                ...
                d = nengo.Ensemble(100, 1, label="d")
