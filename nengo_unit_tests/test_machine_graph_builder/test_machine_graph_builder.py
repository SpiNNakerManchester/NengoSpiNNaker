...
from nengo_unit_tests.test_app_graph_utilities \
    import compare_against_the_nengo_spinnaker_and_gfe_impls_machine_graphs
...
class TestAppGraphBuilder(unittest.TestCase):
    ...
    def run_test(
        ...
        machine = virtual_machine_generator(
            width=16, height=16, virtual_has_wrap_arounds=False,
            version=5, n_cpus_per_chip=18, with_monitors=True,
            down_chips=None, down_cores=None, down_links=None,
            max_sdram_size=None)

        partitioner = NengoPartitioner()
        machine_graph, graph_mapper = partitioner(
            app_graph, machine, random_number_generator,
